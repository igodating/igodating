 ...
 */
import { PageMessageShared } from './pageMessageShared';

export interface ActionResultPageMessageShared { 
    value?: PageMessageShared;
    success?: boolean;
    service?: ActionResultPageMessageShared.ServiceEnum;
    errorCode?: string;
    message?: string;
    errorValue?: any;
    targetUrl?: string;
}
export namespace ActionResultPageMessageShared {
