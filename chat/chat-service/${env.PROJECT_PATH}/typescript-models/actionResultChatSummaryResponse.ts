 ...
 */
import { ChatSummaryResponse } from './chatSummaryResponse';

export interface ActionResultChatSummaryResponse { 
    value?: ChatSummaryResponse;
    success?: boolean;
    service?: ActionResultChatSummaryResponse.ServiceEnum;
    errorCode?: string;
    message?: string;
    errorValue?: any;
    targetUrl?: string;
}
export namespace ActionResultChatSummaryResponse {
