 ...
 */
import { PageChatPaginationShared } from './pageChatPaginationShared';

export interface ActionResultPageChatPaginationShared { 
    value?: PageChatPaginationShared;
    success?: boolean;
    service?: ActionResultPageChatPaginationShared.ServiceEnum;
    errorCode?: string;
    message?: string;
    errorValue?: any;
    targetUrl?: string;
}
export namespace ActionResultPageChatPaginationShared {
